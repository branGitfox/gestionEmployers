                        ...
                        <div class="col-4  shadow p-3">
                            <form method="post">
                                ...
                                <div class="mt-4 mb-1">
                                    ...
                                    <input type="text" class="form-control" id="nom" name="nom" value="<?=empty($roles->getRoleInfo())?'': $roles->getRoleInfo()['name']?>" required>
                                </div>
                                <div class="mt-4 mb-1">
                                ...
                                <path d="M3.35 5.47c-.18.16-.353.322-.518.487A13.134 13.134 0 0 0 1.172 8l.195.288c.335.48.83 1.12 1.465 1.755C4.121 11.332 5.881 12.5 8 12.5c.716 0 1.39-.133 2.02-.36l.77.772A7.029 7.029 0 0 1 8 13.5C3 13.5 0 8 0 8s.939-1.721 2.641-3.238l.708.709zm10.296 8.884-12-12 .708-.708 12 12-.708.708"/>
                                    ...
                                    <input type="password" class="form-control" id="password" name="password" <?= empty($_GET['id'])?'required':'';?>>
                                </div>
                                <div class="mt-4 mb-1">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$role['date']?></td>
                                        <?php if($_SESSION['user']['role_name'] == 'Admin' || $_SESSION['user']['role_name']=='Superviseur'):?>
                                            <?php if($role['role_name'] != 'Admin' && $role['role_name'] != $_SESSION['user']['role_name']):?>
