    ...
    <div class="container w-50">
        <div class="row">
            ...
            <div class="col-3 mx-2 mt-1">
                <button class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
    ...
    <div class="container mt-3 bg-light">
        <table class="table">
            ...
            <?php foreach($avances->listOfAvance() as $avance) :?>
                <tr>
                    <td><?= $avance['name']?></td>
                    <td><?= $avance['firstname']?></td>
                    <?php if($avance['a_espece']==0):?>
                        <td> <?=number_format($avance['a_nature'])?> Ar</td>
                        <?php endif ?>
                    <?php if($avance['a_nature'] == 0):?>
                        <td><?= number_format($avance['a_espece'])?> Ar</td>    
                     <?php endif ?>
                    <?php if($avance['a_espece']==0):?>
                        <td> Nature</td>
                        <?php endif ?>
