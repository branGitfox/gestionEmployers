    ...
    <form method="post">
        <div class="container  pt-1">
            ...
            <div class="row mt-4 justify-content-center ">
                ...
                <input type="radio" class="form-check-input mx-3" value="justifié" name="status" id="justify" required>
                    <label class="form-label" for="nonJustify">Non Justifié</label>
                    <input type="radio" class="form-check-input mx-3" value="non justifié" name="status" id="nonJustify"
                        required>
