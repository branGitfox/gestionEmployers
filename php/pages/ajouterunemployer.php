...
<body>
    ...
    <div class="plaque bg-light shadow d-flex align-items-center justify-content-left p-3"><svg class="me-1" xmlns="http://www.w3.org/2000/svg"
                        width="20" height="20" fill="#3A0CA3" class="bi bi-person-plus" viewBox="0 0 16 16">
                        <path
                    ...
                    </svg><h5 class="fs-6 mt-2 c text-primary ls">AJOUTER</h5>
